**Ниже представлено краткое описание проекта, включая его цель, применяемые технологии и результаты.**

<details>
<summary>## 1. Описание проекта</summary>

Проект направлен на автоматизацию распознавания маркировки на трубных листах с использованием методов компьютерного зрения и сегментации изображений.  
...
<details>
<summary>## 2. Сегментация изображений</summary>
...
<details>
<summary>## 3. Подготовка и разметка данных в Roboflow</summary>
...
<details>
<summary>## 4. Размер и структура датасета</summary>
...
<details>
<summary>## 5. Версия Python</summary>
...
<details>
<summary>## 6. Использованные модели и результаты</summary>
...
<details>
<summary>## 7. Примеры выводов модели</summary>
...
<details>
<summary>## 8. Метрики и результаты оценки</summary>
...
**Матрица ошибок**  
![Confusion](https://drive.google.com/thumbnail?id=110Qdbh0y_WgQQb7yQxNOKeBLWgZnk2Y1&sz=w1000)
...
<details>
<summary>## 10. Порядок запуска</summary>
...
В корне проекта представлен файл **`requirements YOLOv8.txt`** со всеми необходимыми библиотеками.  
